...
<body>
			...
			<img src="data:image/jpeg;base64,'.base64_encode( $row['b_img'] ).'" width="100%">
		...
		<tr>
			...
			<a href="data:image/jpeg;base64,'.base64_encode( $row['b_img'] ).'"rel="lightbox"><img src="images/zoom.gif" ></a>
